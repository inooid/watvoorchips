...
var addToHome = (function (w) {
	var nav = w.navigator,
		...
		intl = {
			en_us: 'Install this tool on your %device: tap %icon and then <strong>Add to Home Screen</strong>.',
			nl_nl: 'Installeer deze handige tool op uw %device: tik %icon en dan <strong>Voeg toe aan beginscherm</strong>.'
		};
...
(function() {
  $(function() {
    if (!window.navigator.standalone) {
      return ($('.header')).removeClass('paddingTop');
    }
  });
